...
nisnps_k4me3_ds = fread("largedata/mediation_paper_revision/DaystoSilk_noind_mediateR_top100.csv", header = T, data.table = F)
...
nisnps_k4me3_gdds = fread("largedata/mediation_paper_revision/GDDDaystoSilk_noind_mediateR_top100.csv", header = T, data.table = F)
...
nisnps_k4me3_dt = fread("largedata/mediation_paper_revision/DaysToTassel_noind_mediateR_top100.csv", header = T, data.table = F)
...
nisnps_k4me3_gddt = fread("largedata/mediation_paper_revision/GDDDaystoTassel_noind_mediateR_top100.csv", header = T, data.table = F)
...
fwrite(o_nisnps_loops_k4me3_ds, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k4me3_ds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k4me3_dt, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k4me3_dt.txt", sep = "\t", row.names = F, quote = F)

fwrite(o_nisnps_loops_k4me3_gdds, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k4me3_gdds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k4me3_gddt, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k4me3_gddt.txt", sep = "\t", row.names = F, quote = F)
...
fwrite(o_med_nisnps_hic_k4me3_ds, "largedata/mediation_paper_revision/o_med_top_new_nisnps_hic_k4me3_ds.txt", sep = "\t", row.names = F, quote = F) #0
fwrite(o_med_nisnps_hic_k4me3_dt, "largedata/mediation_paper_revision/o_med_top_new_nisnps_hic_k4me3_dt.txt", sep = "\t", row.names = F, quote = F) #0
fwrite(o_med_nisnps_hic_k4me3_gdds, "largedata/mediation_paper_revision/o_med_top_new_nisnps_hic_k4me3_gdds.txt", sep = "\t", row.names = F, quote = F) #5
fwrite(o_med_nisnps_hic_k4me3_gddt, "largedata/mediation_paper_revision/o_med_top_new_nisnps_hic_k4me3_gddt.txt", sep = "\t", row.names = F, quote = F) #3
...
# nisnps of days to silk 
nisnps_k27ac3_ds = fread("largedata/mediation_paper_revision/DaystoSilk_noind_mediateR_top100.csv", header = T, data.table = F)
...
# nisnps of GDD to silk 
nisnps_k27ac3_gdds = fread("largedata/mediation_paper_revision/GDDDaystoSilk_noind_mediateR_top100.csv", header = T, data.table = F)
...
# nisnps of days to tassel 
nisnps_k27ac3_dt = fread("largedata/mediation_paper_revision/DaysToTassel_noind_mediateR_top100.csv", header = T, data.table = F)
...
# nisnps of GDD to tassel 
nisnps_k27ac3_gddt = fread("largedata/mediation_paper_revision/GDDDaystoTassel_noind_mediateR_top100.csv", header = T, data.table = F)
...
fwrite(o_nisnps_loops_k27ac3_ds, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k27ac3_ds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k27ac3_dt, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k27ac3_dt.txt", sep = "\t", row.names = F, quote = F)

fwrite(o_nisnps_loops_k27ac3_gdds, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k27ac3_gdds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k27ac3_gddt, "largedata/mediation_paper_revision/o_top_new_nisnps_loops_k27ac3_gddt.txt", sep = "\t", row.names = F, quote = F)
