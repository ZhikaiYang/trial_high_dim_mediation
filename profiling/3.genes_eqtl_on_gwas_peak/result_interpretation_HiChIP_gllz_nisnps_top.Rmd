...
nisnps_k4me3_ds = fread("largedata/march_20/DaystoSilk_noind_gllz_top100.csv", header = T, data.table = F)
...
nisnps_k4me3_gdds = fread("largedata/march_20/GDDDaystoSilk_noind_gllz_top100.csv", header = T, data.table = F)
...
nisnps_k4me3_dt = fread("largedata/march_20/DaysToTassel_noind_gllz_top100.csv", header = T, data.table = F)
...
nisnps_k4me3_gddt = fread("largedata/march_20/GDDDaystoTassel_noind_gllz_top100.csv", header = T, data.table = F)
...
fwrite(o_nisnps_loops_k4me3_ds, "largedata/march_20/o_top_nisnps_loops_k4me3_ds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k4me3_dt, "largedata/march_20/o_top_nisnps_loops_k4me3_dt.txt", sep = "\t", row.names = F, quote = F)

fwrite(o_nisnps_loops_k4me3_gdds, "largedata/march_20/o_top_nisnps_loops_k4me3_gdds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k4me3_gddt, "largedata/march_20/o_top_nisnps_loops_k4me3_gddt.txt", sep = "\t", row.names = F, quote = F)
...
#fwrite(o_med_nisnps_hic_k4me3_ds, "largedata/march_20/o_med_top_nisnps_hic_k4me3_ds.txt", sep = "\t", row.names = F, quote = F) #0
#fwrite(o_med_nisnps_hic_k4me3_dt, "largedata/march_20/o_med_top_nisnps_hic_k4me3_dt.txt", sep = "\t", row.names = F, quote = F) #0
fwrite(o_med_nisnps_hic_k4me3_gdds, "largedata/march_20/o_med_top_nisnps_hic_k4me3_gdds.txt", sep = "\t", row.names = F, quote = F) #5
fwrite(o_med_nisnps_hic_k4me3_gddt, "largedata/march_20/o_med_top_nisnps_hic_k4me3_gddt.txt", sep = "\t", row.names = F, quote = F) #3
...
# nisnps of days to silk 
nisnps_k27ac3_ds = fread("largedata/march_20/DaystoSilk_noind_gllz_top100.csv", header = T, data.table = F)
...
# nisnps of GDD to silk 
nisnps_k27ac3_gdds = fread("largedata/march_20/GDDDaystoSilk_noind_gllz_top100.csv", header = T, data.table = F)
...
# nisnps of days to tassel 
nisnps_k27ac3_dt = fread("largedata/march_20/DaysToTassel_noind_gllz_top100.csv", header = T, data.table = F)
...
# nisnps of GDD to tassel 
nisnps_k27ac3_gddt = fread("largedata/march_20/GDDDaystoTassel_noind_gllz_top100.csv", header = T, data.table = F)
...
fwrite(o_nisnps_loops_k27ac3_ds, "largedata/march_20/o_top_nisnps_loops_k27ac3_ds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k27ac3_dt, "largedata/march_20/o_top_nisnps_loops_k27ac3_dt.txt", sep = "\t", row.names = F, quote = F)

fwrite(o_nisnps_loops_k27ac3_gdds, "largedata/march_20/o_top_nisnps_loops_k27ac3_gdds.txt", sep = "\t", row.names = F, quote = F)
fwrite(o_nisnps_loops_k27ac3_gddt, "largedata/march_20/o_top_nisnps_loops_k27ac3_gddt.txt", sep = "\t", row.names = F, quote = F)
